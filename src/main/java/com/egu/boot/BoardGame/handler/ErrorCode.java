...
public enum ErrorCode {
	...
	USER_DISABLED(null, "탈퇴하거나 이용이 정지된 계정입니다.", 404),
	USERINFO_ALREADY_USED(null, "이미 사용 중인 회원 정보를 포함하고 있습니다.", 404),
	USERINFO_NOT_ENOUGH(null, "회원가입 필요 조건에 충족하지 않습니다.", 404),
	INVALID_PASSWORD(HttpStatus.NOT_FOUND, "비밀번호가 일치하지 않습니다", 404),
